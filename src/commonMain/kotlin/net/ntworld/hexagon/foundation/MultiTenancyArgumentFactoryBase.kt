...
abstract class MultiTenancyArgumentFactoryBase<B : ArgumentBuilderBase, out A : MultiTenancyArgument> :
    ArgumentFactory<B, A> {
    ...
    protected open fun validateArgumentData(builder: B): Boolean {
        ...
        if (builder.tenantId.isNullOrBlank()) {
